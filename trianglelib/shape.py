...
class Triangle(object):
    ...
    def __init__(self, a, b, c):
        ...
        ----------
        ValueError
            Raises `ValueError` if the three length values
            provided cannot actually form a triangle.
    ...
    def scale(self, factor):
        ...
        ----------
        Triangle
            Triangler of which size is multiplied by `factor`
        """
